...
interpreter = Interpreter(nlp, person_reporting_terms, structure_reporting_terms, person_reporting_units,
                                       structure_reporting_units,relevant_article_lemmas)
...
expected_reports.append(Report(['China'], ['Yesterday'], 'destroy', 'home', '8,700', ''))
expected_reports.append(Report(['China'], ['Yesterday'], 'damage', 'home', '66,000', ''))
expected_reports.append(Report(['China'], ['Yesterday'], 'force', 'people', '337,000', ''))
...
expected_reports = []
expected_reports.append(Report(['Afghanistan', 'Pakistan'], ['this year'], 'die', 'person', 160, ''))
expected_reports.append(Report(['Afghanistan', 'Pakistan'], ['this year'], 'strand', 'person', 'dozens', ''))
expected_reports.append(Report(['Afghanistan', 'Pakistan'], ['this year'], 'stick', 'villager', None, ''))
expected_reports.append(Report(['Sarobi'], ['this year'], 'kill', 'people', 61, ''))
expected_reports.append(Report(['Sarobi'], ['this year'], 'wash', 'home', 500, ''))
expected_reports.append(Report(['Nuristan'], ['this year'], 'destroy', 'home', 60, ''))
expected_reports.append(Report(['Khost', 'Nangarhar'], ['this year'], 'die', 'people', 24, ''))
expected_reports.append(Report(['Khost', 'Nangarhar'], ['this year'], 'destroy', 'homes and shops', 50, ''))
expected_reports.append(Report(['Pakistan'], ['this year'], 'die', 'people', 80, ''))
expected_reports.append(Report(['Pakistan'], ['this year'], 'collapse', 'house', None, ''))
...
expected_reports = []
expected_reports.append(Report(['China'], [], 'leave dead', 'people', 14, ''))
expected_reports.append(Report(['China'], ['18 June 2014'], 'destroy', 'home', '8,700', ''))
expected_reports.append(Report(['China'], ['18 June 2014'], 'damage', 'home', '66,000', ''))
expected_reports.append(Report(['China'], ['18 June 2014'], 'force', 'people', '337,000', ''))
